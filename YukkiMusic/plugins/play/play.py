#The sole developer of this file is: @bbnnQ , @cczza #Telegram
    ...
    [
        [
            InlineKeyboardButton(   
              text=f"‹ Solo tree ›", url=f"t.me/solotreee",)                        
        ],        
    ]
)
