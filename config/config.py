...
AUTO_LEAVING_ASSISTANT = getenv("AUTO_LEAVING_ASSISTANT", "5400")
...
# Images
START_IMG_URL = getenv("START_IMG_URL", "https://te.legra.ph/file/1fd4d58900f9fcb399af4.mp4")

PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://te.legra.ph/file/f66f2590909a6f57f35ad.gif",
)
